...
const quantity = prompt('Введите число');
const square = (+quantity) **2
const cube = (+quantity) **3
alert(`${+quantity}\n${+square}\n${+cube}`);
...
const annum;
 ...
 if (age < 18) {
    ...
    const thousendAmount = prompt("Введите желаемую сумму кредита (кратную 1000):");
